...
use crate::core::gen_input::{
    load_gen_input_with_specs_from_json, GenCliOverrides, JsonLoadResult,
};
 ...
 * extra-key warnings are present. Errors are returned as `Err(ErrorEnvelope)`.
 */
pub fn validate_entity_structure(
    ctx: &ProjectContext,
    entity_json: &str,
    cli_vars: &BTreeMap<String, Value>,
